...
def write_html(lon, lat, directory=None, zoom=None):
    ...
    # check dataframe for Nans, if so exit
    if df.isnull().values.any():
        print('There are Nans in the dataframe => the selected lon/lat probably'
              ' leads to a location over the ocean!')
